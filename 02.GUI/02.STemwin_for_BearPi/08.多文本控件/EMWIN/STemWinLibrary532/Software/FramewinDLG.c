...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    //
    hItem = pMsg->hWin;
    FRAMEWIN_SetText(hItem, "BearPi Console");
    //
    ...
    // USER START (Optionally insert additional code for further widget initialization)
		#include <stdio.h>
		char buf[30] = {0};
		sprintf(buf," / | \\     3.1.3 build %s\n",__DATE__);
		MULTIEDIT_AddText(hItem, "\n \\ | /\n");
		MULTIEDIT_AddText(hItem, "- RT -     Thread Operating System\n");
		MULTIEDIT_AddText(hItem, buf);
		MULTIEDIT_AddText(hItem, " 2006 - 2019 Copyright by rt-thread team\n");
		MULTIEDIT_AddText(hItem, "msh >");
    // USER END
    break;
