...
{
    char buf1[2] = {0}, buf2[2] = {0}, buf3[2] = {0};
    sprintf(buf1, "%d", User_Memory_Para.password[0]);
    sprintf(buf2, "%d", User_Memory_Para.password[1]);
    sprintf(buf3, "%d", User_Memory_Para.password[2]);
